...
threshold = 0.0 #schwellwert der klassifizierung in positiv und negativ
...
<<<<<<< HEAD:eki/loss/metrik_selbst_bearbeitet.py
tpr = true_positives / (true_positives+false_negatives)
tnr = true_negatives/(true_negatives+false_positives)
acc = (true_positives+true_negatives) / (n_negatives + n_positives)
bacc = (tpr+tnr) / 2
...
bacc = (tpr + tnr) / 2
precision = true_positives / (true_positives + false_positives)
>>>>>>> a9f9386b328fe02f68bca741fc5d755d3dd6eb5f:eki/loss/metrik.py
